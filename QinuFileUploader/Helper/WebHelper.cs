...
namespace QinuFileUploader.Helper
{
    ...
    {//实例化
        ...
        public string Getdata(string url, Method method = Method.GET, Dictionary<string, object> paramsData = null)
        {
        ...
        /// <returns></returns>
        private HttpWebResponse CreatePostHttpResponse(string url, IDictionary<string, object> parameters)
        {
        ...
        /// <returns></returns>
        private HttpWebResponse CreateGetHttpResponse(string url, IDictionary<string, object> paramsData)
        {
            ...
            if (paramsData != null && paramsData.Count != 0)
            {
                ...
                {
                    paramsStrList.Add(item.Key + "=" + (string)item.Value);
                }
